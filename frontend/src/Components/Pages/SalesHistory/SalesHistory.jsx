...
const SalesHistory = () => {
  ...
  const filteredSales = useMemo(() => {
    return salesHistory.filter((sale) => {
      ...
      const matchesType = filterType ? sale.paymentDetails.paymentMethod === filterType : true;
...
<button className="addnewbtntop" variant="contained" onClick={() => window.history.back()}>
        Back to Sales
      </button>
