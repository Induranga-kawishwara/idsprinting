...
const Sales = () => {
  ...
  const generatePDF = (paymentDetails) => {
    ...
    doc.text(
      text,
      pageWidth - textWidth - 5.5, // Position X: Page width minus text width and some padding
      lastProductY + 7
    );
    ...
    const discountXPosition = pageWidth - discountTextWidth - 5.5; // Align it to the right by subtracting from the total width
