...
import { dataset as basicDataset } from "./basicDataset";
...
export default function ChartsOverviewDemo() {
  ...
  return (
    <div>
      ...
      <LineChart
        dataset={basicDataset} // Use the renamed variable here
        xAxis={[{ dataKey: "x" }]}
        series={[{ dataKey: "y" }]}
        height={300}
      ...
      <Box sx={{ width: "100%" }}>
        <Stack direction="row" spacing={1} sx={{ mb: 2 }}>
          <FormControlLabel
            ...
            control={
              <Checkbox
                onChange={(event) => setFixMargin(event.target.checked)}
              />
            }
          ...
          <FormControlLabel
            ...
            control={
              <Checkbox
                onChange={(event) => setFixLabel(event.target.checked)}
              />
            }
        ...
        <BarChart
          xAxis={[
            {
              ...
              valueFormatter: (value, context) =>
                context.location === "tick"
                  ? value.split("").join("\n")
                  : usAirportPassengers.find((item) => item.code === value)
                      .fullName,
              label: "airports",
              labelStyle: fixLabel
                ? {
          ...
          // Modify the margin
          margin={
            fixMargin ? { top: 5, right: 5, bottom: 80, left: 100 } : undefined
          }
          sx={
            fixLabel
              ? {
